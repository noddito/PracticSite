        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'User Orders'),
                    ...
                    [
                        'label' => Yii::t('backend', 'Order Statuses'),
                    ...
                    [
                        'label' => Yii::t('backend', 'Variable Properties'),
                        'icon' => '<i class="fa fa-bars"></i>',
                        'url' => ['/variable-property/index'],
                        'active' => (Yii::$app->controller->id === 'user'),
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                        'label' => Yii::t('backend', 'Attributes'),
                        'icon' => '<i class="fa fa-plus-circle"></i>',
                        'url' => ['/property-attribute/index'],
                        'active' => (Yii::$app->controller->id === 'user'),
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                        'label' => Yii::t('backend', 'Tree'),

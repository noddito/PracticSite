...
return [
    ...
    'Create Product Tags' => 'Создать тег продукта',
    'Create Product' => 'Создать продукт',
    'Create Product Category' => 'Создать категорию продукта',
    'Update product' => 'Изменить продукт',
    'Select tags' => 'Выберите тэги... ',
    'Tags' => 'Тэги',
    'Updating' => 'Изменение',
    'Tree' => 'Древо',
    'Select Parent Category' => 'Выберите родительскую категорию',
    'Create Product Property' => 'Создать свойство продукта',
    'Property' => 'Свойства',
    'Variable Properties' => 'Вариативные свойства',
    'Attributes' => 'Атрибуты',
    'Create Property Attributes' => 'Создать атрибут свойства',
    'Create Variable Properties' => 'Создать вариатиное свойство',
    'Update Variable Properties: ' => 'Изменить вариативное свойство: ',
    'Update Property Attributes: ' => 'Изменить атрибут свойства: ',
    'Update User Order: ' => 'Изменить пользовательский заказ : №',
    'Create User Order' => 'Создать заказ',
    'User Orders' => 'Заказы пользователей',
    'Status Name' => 'Наименование статуса',
    'Create Status' => 'Создать статус',
    'Update Status №' => 'Изменить статус №',
    'Order Statuses' => 'Статусы Заказа',
    'Update Variable Properties' => 'Изменить вариативное свойство',
    'Update Property' => 'Изменить свойство',
];

...
return [
    ...
    'Order №' => 'Заказ №',
    'Orders' => 'Заказы',
    'I haven`t account' => 'У меня нет аккаунта',
    'Registration' => 'Регистрация',
    'Register' => 'Зарегистрироваться',
    'Profile' => 'Профиль',
    'Your order has been successfully created' => 'Ваш заказ успешно создан',
    'Your message has been successfully sent' => 'Ваш сообщение успешно отправлено',
    'I don`t remember password' => 'Я не помню пароль',
    'Password recovery' => 'Восстановление пароля',
    'Recovery' => 'Восстановить',
    'Entering a new password' => 'Ввод нового пароля',
    'The entered passwords do not match' => 'Введенные пароли не совпадают',
    'You have not entered a password' => 'Вы не ввели пароль',
    'This link does not exist' => 'Такой ссылки не существует',
    'Password has been changed' => 'Пароль успешно изменен',
    'Enter new password' => 'Введите новый пароль',
    'Repeat new password' => 'Повторите новый пароль',
    'There is no account with this email, please register' => 'Аккаунта с таким адресом почты не существует, пожалуйста зарегистрируйтесь',
    'A password recovery email has been sent to your email' => 'На вашу электронную почту отправлено письмо для восстановления пароля',
];
